...
solution_prefix = cfn_stack_outputs.get('SolutionPrefix', 'sagemaker-soln-graph-german-risk')
...
ecr_repository = cfn_stack_outputs.get('SageMakerProcessingJobContainerName', 'sagemaker-soln-graph-german-risk-preprocessing')
